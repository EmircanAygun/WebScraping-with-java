...
public class trendyol {
    private static final String EBAY_GLOBAL_DEALS_URL = "https://www.trendyol.com/laptop-x-c103108?pi=";
    
    private static final String PRODUCT_CARD_CLASS = "p-card-wrppr with-campaign-view";
    //private static final String PRODUCT_TITLE_CLASS = "prdct-desc-cntnr-name hasRatings";
    private static final String PRODUCT_LINK_SELECTOR = "div.p-card-chldrn-cntnr.card-border a";
